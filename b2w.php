...
unlink('glassdoorfinalb2w.csv');
file_put_contents('glassdoorfinalb2w.csv', "\xEF\xBB\xBF", FILE_APPEND | LOCK_EX);
...
{
    if($j == 0)
        $url = "https://www.glassdoor.com.br/Avalia%C3%A7%C3%B5es/B2W-Digital-Avalia%C3%A7%C3%B5es-E231773.htm";
    else
        $url = "https://www.glassdoor.com.br/Avalia%C3%A7%C3%B5es/B2W-Digital-Avalia%C3%A7%C3%B5es-E231773_P".$j.".htm";
...
{
    file_put_contents('glassdoorfinalb2w.csv', implode(";",$row)."\n", FILE_APPEND | LOCK_EX);
}
