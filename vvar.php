...
unlink('glassdoorfinal.csv');
file_put_contents('glassdoorfinal.csv', "\xEF\xBB\xBF", FILE_APPEND | LOCK_EX);
...
for($j = 0;$j < 175;$j++)
{
    if($j == 0)
        ...
        $url = "https://www.glassdoor.com.br/Avalia%C3%A7%C3%B5es/Via-Varejo-Avalia%C3%A7%C3%B5es-E2002288_P".$j.".htm";
...
{
    file_put_contents('glassdoorfinal.csv', implode(";",$row)."\n", FILE_APPEND | LOCK_EX);
}
