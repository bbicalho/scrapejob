...
unlink('glassdoorfinallasa.csv');
file_put_contents('glassdoorfinallasa.csv', "\xEF\xBB\xBF", FILE_APPEND | LOCK_EX);
...
{
    if($j == 0)
        $url = "https://www.glassdoor.com.br/Avalia%C3%A7%C3%B5es/Lojas-Americanas-Avalia%C3%A7%C3%B5es-E10939.htm";
    else
        $url = "https://www.glassdoor.com.br/Avalia%C3%A7%C3%B5es/Lojas-Americanas-Avalia%C3%A7%C3%B5es-E10939_P".$j.".htm";
...
{
    file_put_contents('glassdoorfinallasa.csv', implode(";",$row)."\n", FILE_APPEND | LOCK_EX);
}
